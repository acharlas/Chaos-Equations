...
const float STEPS = 1.;
const float CUTOFF = 0.20; //depth less than this, show white wall
const vec2  OFFSET = vec2(0.008,0.008); //drop shadow offset
...
void main() {
  ...
  if (noise < CUTOFF)
  {
    ...
    float noiseOff = getNoise(vUv + OFFSET, t);
